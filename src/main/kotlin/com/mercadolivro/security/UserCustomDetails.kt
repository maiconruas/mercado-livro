...
class UserCustomDetails( val customerModel: CustomerModel): UserDetails {
    ...
    override fun getAuthorities(): MutableCollection<out GrantedAuthority> = customerModel
    ...
    override fun isEnabled(): Boolean = customerModel.status == CostumerStatus.ATIVO
}